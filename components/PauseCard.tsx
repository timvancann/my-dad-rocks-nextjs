...
export const PauseCard = ({pause}: { pause: SongType }) => {
  ...
  return (
    <motion.div
      className={`flex flex-col grow gap-1 px-3 py-0 rounded-xl "bg-transparent"}`}>
...
const Button = () => {
  ...
  return <motion.button className={"py-2 text-rosePine-text/80"}
...
const PauseExtra = ({song, isExpanded, setIsExpanded}: {
  song: SongType,
  isExpanded: boolean,
